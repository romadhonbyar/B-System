...
$lang['manage_add_staff_button_back_explanation']    = 'The back button works for the <a href="'.site_url('manage/user/staff').'">staff data</a> page.';
$lang['manage_add_staff_view_data_explanation']      = 'To see the staff data already saved, please go to the <a href="'.site_url('manage/user/staff').'">staff data</a> page.';
...
$lang['manage_edit_staff_button_back_explanation']    = 'The back button works for the <a href="'.site_url('manage/user/staff').'">staff data</a> page.';
$lang['manage_edit_staff_view_data_explanation']      = 'To see the staff data already saved, please go to the <a href="'.site_url('manage/user/staff').'">staff data</a> page.';
...
// staff table
$lang['manage_table_staff_title_id']            = '#UserCode';
