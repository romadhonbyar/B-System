...
class Ion_auth_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->identity_column_alt = $this->config->item('identity_alt', 'ion_auth'); // Edit: rombyar
    ...
    public function login($identity, $password, $remember=false)
    {
        ...
        $query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login') // Edit: rombyar
                          ->where($this->identity_column, $identity)
                          ->or_where($this->identity_column_alt, $identity) // Edit: rombyar
                          ->limit(1)
                          ->order_by('id', 'desc')
                          ->get($this->tables['users']);
