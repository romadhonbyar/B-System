<script>
    ...
    <?php
    $modal_body_ =
    "modal_body_ += '<form action=\"#\" id=\"form-user-edit\" class=\"needs-validation\" novalidate=\"\" method=\"POST\" accept-charset=\"utf-8\" enctype=\"multipart/form-data\">';
    ...
    $(function() {
        ...
        /** Bind it: */
        $('#form-user-edit').on('keyup change', function(e) {
            myHandler(e);
        });
    });
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            window.setTimeout(function() {
                                /** RESET FORM */
                                /** modal.find('#form-user-edit')[0].reset(); Reset all form input */
                                ...
                                $('#form-user-edit').removeClass('was-validated');
                            }, 5000);
                        } else {
                            $('.modal').removeClass('modal-progress');
                            var alert = response.type;
