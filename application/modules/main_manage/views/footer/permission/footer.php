    ...
    <?php $this->load->view('main_manage/footer/permission/footer-main/main-datatables'); ?>
    <?php $this->load->view('main_manage/footer/permission/footer-main/main-sweetalert'); ?>
    ...
    <?php $this->load->view('main_manage/footer/permission/footer-special/special-extra'); ?>

    <!-- === MODAL CRUD === -->
    <?php $this->load->view('main_manage/footer/permission/footer-main/main-crud-add-permission'); ?>
