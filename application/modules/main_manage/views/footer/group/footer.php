    ...
    <?php $this->load->view('main_manage/footer/group/footer-main/main-datatables'); ?>
    <?php $this->load->view('main_manage/footer/group/footer-main/main-sweetalert'); ?>
    ...
    <!-- === MODAL CRUD === -->
    <?php $this->load->view('main_manage/footer/group/footer-main/main-crud-add-group'); ?>

    <!-- === Page Specific JS File SPECIAL === -->
    <?php $this->load->view('main_manage/footer/group/footer-special/special-extra'); ?>
