<div class="section-body">
    ...
    ?>
					...
					<div class="card-header">
						<?php $this->load->view(
          'template_backend/component/element/section-body/sb-card-header-title'
      ); ?>
					</div>
					<div class="card-body">
					...
					<div class="card-footer text-right bg-whitesmoke">
						<a href="" class="btn btn-warning btn-submit-load">Kembali ke List</a>
						<button class="btn btn-primary btn-submit-load">Simpan</button>
					</div>
				<?php echo form_close(); ?>
			</div> <!-- card -->
