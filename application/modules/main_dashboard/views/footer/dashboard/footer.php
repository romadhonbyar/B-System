    ...
    <?php $this->load->view('main_dashboard/footer/dashboard/footer-main/main-datatables'); ?>
    <?php $this->load->view('main_dashboard/footer/dashboard/footer-main/main-sweetalert'); ?>
    ...
    <?php $this->load->view('main_dashboard/footer/dashboard/footer-special/special-extra'); ?>
