 ...
 */
$config['site_title'] = 'EMSystem'; // Site Title, example.com
$config['site_title_main'] = 'EM'; // Site Title, example.com
$config['site_title_second'] = 'System'; // Site Title, example.com
$config['site_title_version'] = '2.0'; // Site Title, example.com
$config['site_title_slogan'] = 'EM System Base!'; // Site Title, example.com

$config['admin_email'] = 'cs@rom.web.id'; // Admin Email, admin@example.com
...
$config['identity_alt'] = 'email'; //identity alt
$config['default_password'] = '12345';

$config['full_name'] = 'yes';
$config['min_password_length'] = 8; //buat dinamis              // Minimum Required Length of Password
$config['max_password_length'] = 30; //buat dinamis              // Maximum Allowed Length of Password
...
$config[
    'lockout_time'
] = 600; /* The number of seconds to lockout an account due to exceeded attempts
 You should not use a value below 60 (1 minute) */
$config[
    'forgot_password_expiration'
] = 1800; /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config[
    'recheck_timer'
] = 600; /* The number of seconds after which the session is checked again against database to see if the user still exists and is active.
